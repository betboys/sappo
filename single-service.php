...
<section class="page-hero single-page-hero" id="single">
    ...
    <div class="single-hero-heading-text-inner">
        <div class="container">
            <h1 class="heading single-heading split"><?= the_field('title'); ?></h1>
        </div>
...
<section class="single-security-services">
    <div class="single-content-left">
        <div class="container">
            <h3 class="headingN2 split"><?= the_field('left_text');  ?></h3>
        </div>
    </div>
...
?>
        <section class="left-and-right">
            ...
            <div class="left-and-right-text-inner">
                <div class="container">
                    <h3 class="left-and-right-title split"><?= $text_title ?></h3>
                </div>
    ...
    <section class="wcsss">
        <div class="wcsss-text-inner">
            <div class="wcsss-left">
                <div class="container">
                    <h3 class="headingN2 split"><?= the_field('feature_title'); ?>
                    </h3>
                </div>
            </div>
        ...
        <div class="wcsss-items-inner">
            ...
            if (have_rows('fearue_boxes')) :
                ...
                // Loop through rows.
                while (have_rows('fearue_boxes')) : the_row();
...
<section class="other-services-wraper">
    <div class="container">
        <h3 class="other-services split">Other <span class="text-color-style">services</span></h3>
    </div>
...
<section class="our-trusted-partners swiper-container">
    <div class="ttile-and-slide-buttons">
        <div class="container">
            <h3 class="our-trusted-partners-title split">trusted by</h3>
        </div>
            ...
            <div class="swiper-slide master-master-inner">
                <div class="master-inner">
                    <div class="card-intro">
                        <div class="side-1">
                            <img class="chief" src="<?php echo get_template_directory_uri(); ?>/images/partners-image.webp" alt="">
                        </div>
                        <div class="side-2">
